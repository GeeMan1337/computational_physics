%graph for question 1j_2
graph_data = readtable('E:\computational_physics\Module_1_out\graph_data_1i_4.dat');
...
title('10^4 sums of 10^4 random numbers (either -1 or 1) with bin size 5 (normalised)');
