%graph for question 1h_6
graph_data = readtable('E:\computational_physics\Module_1_out\graph_data_1h_3.dat');
...
title('10^4 sums of 10^4 random numbers in [0,1] with bin size 2 (normalised)');
