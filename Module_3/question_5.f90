program questions
    ...
    do i = 1, 20
        call ising_model(10, 1.0, 4.05, 50000, "random", answers, 1, "dont write")
    ...
    call ising_model(10, 1.0, 4.05, 50000, "random", answers, 1, "E:\computational_physics\Module_3_out\question_5_data.dat")
