program questions
    ...
    open(unit=1, file="E:\computational_physics\Module_3_out\question_7b_data.dat")

    do i = 470, 380, -2
        call ising_model(len, 1.0, i/100.0, 1010000, "random", answers, 1, "dont write")
        write(1,*) i/100.0, ",", answers(1)/(len**3), ",", answers(2)/(len**3), ",", &
        answers(3), ",", answers(4), ",", answers(5)/(len**3), ",", answers(6), ",", answers(7)
    
        print *, "temperature =", i/100.0, "L =", len
    end do
